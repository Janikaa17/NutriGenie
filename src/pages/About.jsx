...
import veggie from "../assets/healthy.png";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="bg-[#E8F7F1] p-10 flex flex-col items-start border-b md:border-b-0 md:border-r border-gray-200">
                            ...
                            <ul className="list-disc list-inside text-gray-700 text-sm space-y-2">
                                <li>Helps maintain muscle mass and strength</li>
                                <li>Keeps you feeling full and satisfied</li>
                        ...
                        <div className="bg-[#22B573] p-10 flex flex-col items-start border-b md:border-b-0 md:border-r border-gray-200">
                            ...
                            <ul className="list-disc list-inside text-white text-sm space-y-2">
                                <li>Prevents fatigue and boosts energy</li>
                                <li>Supports learning and focus</li>
                        ...
                        <div className="bg-[#E8F7F1] p-10 flex flex-col items-start">
                            ...
                            <ul className="list-disc list-inside textblack text-sm space-y-2">
                                <li>Improves heart and gut health</li>
                                <li>Reduces cholesterol and inflammation</li>
                                <li>Supports a healthy planet</li>
                            </ul>
                        </div>
                    </div>
                </div>
